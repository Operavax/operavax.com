  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center overflow-hidden bg-white">
      ...
      <div className="relative z-10 flex flex-col items-center gap-7">
        ...
        >
          <div className="text-sm tracking-wide text-[#9aa0a6]">{statusText}</div>
          {subText && <div className="text-xs text-[#dadce0]">{subText}</div>}
        </div>
        ...
        >
          <div
            ...
            style={{
              ...
              animation: "splash-load-loop 2s cubic-bezier(0.4,0,0.2,1) infinite",
            }}
          />
        </div>
      </div>
